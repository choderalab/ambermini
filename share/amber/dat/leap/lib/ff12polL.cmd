...
#    nucleic acids..
#
loadAmberPrep all_nuc12polL.in
#
a = { DA5  DT5  DG5  DC5  } 
b = { DA3  DT3  DG3  DC3  } 
c = { RA5  RU5  RG5  RC5  } 
...
set   UU      tail       null
#
saveOff a ./all_ff12polL.lib
saveOff b ./all_ff12polL.lib
saveOff c ./all_ff12polL.lib
saveOff d ./all_ff12polL.lib
saveOff e ./all_ff12polL.lib
saveOff f ./all_ff12polL.lib
saveOff g ./all_ff12polL.lib
saveOff h ./all_ff12polL.lib
saveOff i ./all_ff12polL.lib
saveOff j ./all_ff12polL.lib
#
#    amino acids..
#
################################################
...
################################################
######
######   AMBER 12polL polarizable FF prep.in files
######
################################################
################################################
################################################
...
clearVariables
#
# Extract the amino acids from all_amino12polL.in
#
loadAmberPrep all_amino12polL.in 
...
loadAmberPrep all_aminont12polL.in N
...
loadAmberPrep all_aminoct12polL.in C
