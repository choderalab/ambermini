...
BoxClassRec boxClassRec = {
  {
/* core_class fields      */
    /* superclass         */    (WidgetClass) &containerClassRec,
    /* class_name         */    "Box",
  ...
  {
    /* geometry manager   */    GeometryManager, /*geometry_manager, */
    /* change_managed     */    ChangeManaged, /*changed_managed, */
    /* insert_child       */    XtInheritInsertChild,
    /* delete_child       */    XtInheritInsertChild,
    /* extension          */    NULL,
  },
